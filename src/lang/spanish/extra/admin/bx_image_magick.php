...
define('BX_IMAGE_MAGICK_DESCRIPTION', 'Módulo para la edición de imágenes con ImageMagick, incluyendo soporte para perfiles de color ICC para conversiones CMYK y RGB.');
